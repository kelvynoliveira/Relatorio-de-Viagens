        ...
        return L.divIcon({
            ...
            html: `
                <div class="relative flex items-center justify-center">
                    ...
                    ` : ''}
                    <div class="w-12 h-12 rounded-full border-4 ${isTraveling ? 'border-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.5)]' : isWorking ? 'border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.5)]' : 'border-white/20'} overflow-hidden bg-[#0a0a0b] transition-all hover:scale-110">
