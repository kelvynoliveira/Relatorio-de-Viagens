...
-- Run this to clear the database and start fresh if you have errors
drop table if exists campus_visits cascade;
drop table if exists toll_entries cascade;
drop table if exists fuel_entries cascade;
drop table if exists displacement_legs cascade;
